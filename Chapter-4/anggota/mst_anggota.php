            ...
            <div class="col-lg-12">
                <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
                    <p><a class="btn btn-primary" href="index.php?pilih=1.2&aksi=aktif">
                        ...
                        <a class="btn btn-primary" href="index.php?pilih=1.2&aksi=keluar">
                            <i class="glyphicon glyphicon-subtitles">
                            </i> Nonaktif</a>
                        <a href="?pilih=1.2&aksi=tambah" class="btn btn-primary">
                            <span class='glyphicon glyphicon-plus'>
                            </span> Tambah Anggota</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
                    <p><a class="btn btn-primary" href="index.php?pilih=1.2&aksi=aktif">
                            <i class="glyphicon glyphicon-sd-video"></i> Aktif</a>
                        <a class="btn btn-primary" href="index.php?pilih=1.2&aksi=keluar">
                            <i class="glyphicon glyphicon-subtitles"></i> Nonaktif</a>
                        <a href="?pilih=1.2&aksi=tambah" class="btn btn-primary">

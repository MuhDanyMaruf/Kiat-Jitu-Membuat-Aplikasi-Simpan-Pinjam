<div class="row mt">
  <div class="col-lg-12">
    <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
      ...
      <p>Berisi data Anggota, admin dapat menambahkan mengedit atau menghapus
        (semua data transaksi anggota yg dihapus akan juga ikut terhapus)</p>
    ...
    <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
      ...
      <p>Anggota dapat mengambil uang dari tabungannya,
        setiap 1 bulan tabungan akan bertambah 10000(tergantung) ini sebagai investasi bagi anggota</p>
    </div>
    <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
    ...
    <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
      ...
      <p>Simpanan wajib setiap 1 minggu anggota wajib melakukan simpanan ditentukan mulai
        saat mendaftar diri, jika belum mencapai 1 minggu maka button wajib akan disabled</p>
    ...
    <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
      ...
      <p>Terdapat laporan simpanan supaya tahu berapa simpanan yang dilakukan dan totalnya berapa(ini hanya unutk mengetahui saja ,
        ini bukanlah tabungan)</p>
      <p>Terdapat laporan pinjaman<br>1. Semua Pinjaman : ini berisi semua pinjamn yang dialukukan
        <br>2. jatuh tempo : apabila tanggal sekarang = tanggal jatuh tempo
        <br>3. telat : apabila tanggal sekarang melebihi tanggal jatuh tempo dan dikali 1000/perhari(tergantung)
      </p>
    </div>
    <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
      <h4 style="color:#d9534f;">Pengaturan Simpanan</h4>
      <p>terdapat 3 jenis simpanan<br>1. wajib : dibayar sesuai jangka waktu tertentu dan jumlah tertentu
        <br>2. sukarela : tidak ditentukan waktu dan jumlah pembayarannya
        <br>3. pokok : dibayar saat pertama kali mendaftar
      </p>
    </div>
    <div class="form-panel" style="border-left:5px solid#d9534f;border-right:5px solid#d9534f;">
